        ...
        <div className="row">
          ...
          <div className="col-sm-5">
            ...
            <div className="row mt-3">
              <ul className="list-group list-group-horizontal-md">
                <li className="list-group-item border-0">Seenlist {seen.count}</li>
                <li className="list-group-item border-0">Favoritelist {favorite.count}</li>
                <li className="list-group-item border-0">
                  <a href={user.socials.instagram} className='text-dark' target="_blank" rel="noreferrer" >
                ...
                <li className="list-group-item border-0">
                  <a href={user.socials.twitter} className='text-dark' target="_blank" rel="noreferrer" >
